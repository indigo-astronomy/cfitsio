...
prefix		= /Users/polakovic/Development/cfitsio-3.49
exec_prefix	= ${prefix}
...
RANLIB =	ranlib
CC =		gcc
CFLAGS =	-g -arch arm64 -arch x86_64 -mmacosx-version-min=10.10 -fPIC -O3 -Dg77Fortran -fPIC -fno-common
CPPFLAGS =	
SSE_FLAGS =	
FC =		notfound
LDFLAGS =	-g -arch arm64 -arch x86_64 -mmacosx-version-min=10.10 -fPIC -O3
LDFLAGS_BIN =	-g -arch arm64 -arch x86_64 -mmacosx-version-min=10.10 -fPIC -O3 -Wl,-rpath,${CFITSIO_LIB}
...
SHLIB_LD =	gcc -dynamiclib  -headerpad_max_install_names -install_name @rpath/lib${PACKAGE}.${CFITSIO_SONAME}${SHLIB_SUFFIX} -compatibility_version ${CFITSIO_SONAME} -current_version ${CFITSIO_SONAME}.${CFITSIO_MAJOR}.${CFITSIO_MINOR}
SHLIB_SUFFIX =	.dylib
